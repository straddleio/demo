...
export const ChargeCard: React.FC = () => {
  ...
  const paymentRail = 'ach'; // TODO: Extract from API response
  const consentType = 'internet'; // TODO: Extract from API response
  const balanceBefore = 0; // TODO: Extract from API response
  const balanceAfter = 0; // TODO: Extract from API response
  const balanceCheckPassed = true; // TODO: Extract from API response
